<template>
  <div class="w-full flex items-center justify-center bg-gradient-to-br from-blue-50 to-slate-100 overflow-y-auto h-[90%] min-h-0 ">
    <div class="w-full max-w-md bg-white rounded-xl shadow-lg p-6 my-12 mx-4">
      ...
      <div v-if="user">
        <div class="mb-6">
          ...
          <div class="w-full mt-1 pb-1 border-b border-slate-300 text-lg text-slate-700 font-bold select-text">{{ user.username }}</div>
        </div>
        <button
